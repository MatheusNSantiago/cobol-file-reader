...
#     fileconvertion(
#         [
#             "extract_ebcdic_to_ascii.py",
#             "-s3-json",
#             "s3://" + os.environ.get("layout") + jfle,
#             "-s3-input",
#             "s3://" + bkt + "/" + key,
#         ],
#         tmp="/tmp/",
...
#         + ".".join(s3_url.split("?")[0].split("/")[-1].split(".")[:-2])
#         + ".json"
#     )
#
#     fileconvertion(
...
def fileconvertion(args, route="", tkn="", tmp=""):
    ...
    while i < prm.general["max"] or prm.general["max"] == 0:
        ...
        if i > prm.general["skip"]:
            ...
            if prm.general["print"] != 0 and i % prm.general["print"] == 0:
            ...
            for transf in layout:
                ...
                OutRecord.addField(
                    ...
                    transf["type"],
                    transf["part-key"],
                    prm.general["partkname"],
                    transf["sort-key"],
                    prm.general["sortkname"],
                    prm.AddDecPlaces(
                        ebcdic.unpack(
                            record[
